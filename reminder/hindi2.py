...
def speak(text: str,speed: float = 1.5):
    """
    Speak the given text faster , aloud in natural Indian Hindi-English (Hinglish).
    """
    ...
    if status == "today":
        return (
          ...
          f"आपका {amount} रुपए का payment आज {due_date} को बकाया है। "
           "कृपया आज समय से पर भुगतान करें, या हमारे ऐप से तुरंत payment कर सकते हैं, "
        ...
        return (
            ...
            "यह आप हमारे ऐप से भी जल्दी payment कर सकते हैं। "
            "जिसे आप प्लेस्टोर या ऐप स्टोर से डाउनलोड कर सकते हैं। "
